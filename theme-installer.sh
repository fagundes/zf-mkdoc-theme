...
if [[ ! -d "zf-mkdoc-theme/theme" ]];then
    ...
    curl -s -L https://github.com/fagundes/zf-mkdoc-theme/releases/latest | egrep -o '/fagundes/zf-mkdoc-theme/archive/[0-9]*\.[0-9]*\.[0-9]*\.tar\.gz' | head -n1 | wget -O zf-mkdoc-theme.tgz --base=https://github.com/ -i - ;
    (
        cd zf-mkdoc-theme ;
